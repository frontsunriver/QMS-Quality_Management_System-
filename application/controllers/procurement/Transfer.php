...
class Transfer extends MY_Controller {
	...
	function index() {
		...
		$this->render('procurement/transfer/list', $this->mLayout);
	}
	...
	function view($id) {
		...
		$this->render('procurement/transfer/view', $this->mLayout);
	}
	...
	function pdf($id) {
		...
		$content = $this->load->view('procurement/transfer/pdf', $data, true);

		$this->load->library('html2pdf');
		$this->html2pdf->folder(UPLOAD_URL . 'ims/procurement/transfer');
	...
	function done($id) {
		...
		$this->success('procurement/transfer');

		// $this->redirect('procurement/transfer');
	}
}