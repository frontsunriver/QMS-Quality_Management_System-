...
class Shiporder extends MY_Controller
{
    ...
    function index() {
        ...
        $this->render('manufacture/shiporder/list', $this->mLayout);
    }
    ...
    function create($id = -1) {
        ...
        if (!$order) {
            ...
            $this->mContent['partners'] = $this->Ims_customer_model->find(['consultant_id' => $this->mUser->consultant_id]);
            ...
            $this->mContent['ship_products'] = $this->Ims_ship_order_product_model->find(["B.id" => $id], [], ["A.*"]);

            $this->render('manufacture/shiporder/create', $this->mLayout);
        } else {
