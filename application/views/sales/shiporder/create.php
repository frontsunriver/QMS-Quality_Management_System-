	...
	<div class="panel panel-flat">
		<div class="panel-heading" style="border-bottom: 1px solid #eee;">
			...
			<div class="pull-right">
				...
				<a class="btn btn-default" href="<?= base_url('sales/shiporder') ?>">Cancel</a>
			</div>
		</div>
		<div class="container-fluid">
			<form id="create_form" action="<?= base_url('sales/shiporder/create') ?>/<?= $shiporder ? $shiporder->id : '' ?>" method="post">
				<input type="hidden" name="shiporder[salesorder_id]" value="<?= $shiporder->salesorder_id ?>" />
...
<script type="text/javascript" src="<?= base_url(JS_URL . 'user/sales/shiporder/create.js') ?>"></script>