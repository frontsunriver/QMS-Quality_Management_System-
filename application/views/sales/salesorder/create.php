	...
	<div class="panel panel-flat">
		<div class="panel-heading" style="padding-bottom: 0px;">
			...
			<div class="pull-right">
				...
				<?php } else if ($salesorder->state == 0) { ?>
					<button type="button" class="btn btn-success" onclick="javascript:onDelivery(<?= $salesorder->id ?>);">Delivery</button>
					<button type="button" class="btn bg-blue" onclick="javascript:onCreate();">Update</button>
				<?php } ?>
									...
									<div class="col-lg-12">
										<div class="row">
											<div class="table-responsive">
												<button type="button" id="add_btn" class="btn bg-blue btn-xs" style="margin: 5px 0;" onclick="javascrit:onAddProduct();">Add a product <i class="fa fa-plus"></i></button>
												<table class="table datatable-basic">
													...
													<tbody>
														...
														?>
																	<tr>
																		<td>
																			<select data-plugin-selectTwo id="product<?= $iPos ?>" class="form-control form-control-sm populate placeholder" name="product[<?= $iPos ?>][product_id]" data-plugin-options='{ "placeholder": "Select a item", "allowClear": true }' required>
