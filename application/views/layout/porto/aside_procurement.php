			...
			<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1">
				<nav>
					<ul class="nav nav-pills" id="mainNav">
						<li id="purchaseorderreport">
							<a class="nav-link" href="<?= base_url('procurement/purchaseorderreport') ?>">
								Purchase Orders Report
							</a>
						</li>
						<li id="purchaseorder">
							<a class="nav-link" href="<?= base_url('procurement/purchaseorder') ?>">
								Purchase Order
							</a>
						</li>
						<li id="transfer">
							<a class="nav-link" href="<?= base_url('procurement/transfer') ?>">
								Transfer
							</a>
						</li>
						<li id="material">
							<a class="nav-link" href="<?= base_url('procurement/material') ?>">
								Material Wise Stocks
							</a>
						</li>
						<!-- <li id="product">
							<a class="nav-link" href="<?= base_url('procurement/product') ?>">
								Product Wise Stock
							</a>
						</li> -->
						<li id="supplier">
							<a class="nav-link" href="<?= base_url('procurement/supplier') ?>">
								Supplier
							</a>
						</li>
					</ul>
