...
<div class="content">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title" style="display: inline-block;">Product Category</h5>
...
<script type="text/javascript" src="<?= base_url(JS_URL . 'user/manufacture/category.js') ?>"></script>