...
<div class="content">
	<div class="panel panel-flat">
		<div class="panel-heading" style="border-bottom: 1px solid #eee;">
			<h5 class="panel-title" style="display: inline-block;">Product&nbsp;<?= $count ? '(' . $count . ')' : '' ?></h5>
			<!-- <button type="button" class="btn bg-blue pull-right" onclick="javascript:onCreate();">Create</button> -->
			<div class="form-group pull-right">
				<div class="form-group has-feedback" style="position: relative;">
					<form action="<?= base_url('manufacture/product') ?>" method="get">
								...
								<div class="panel panel-body">
									<div class="media">
										<div class="media-left">
											<a href="<?= base_url("manufacture/product/create/{$item->id}") ?>" data-popup="lightbox">
										...
										<div class="media-body">
											...
											<h7 class="text-bold"><?= $item->variants ?> Variants</h7>
											<div class="text-muted">Price: $ <?= $item->sales_price ?>.00</div>
											<div class="text-muted">On Hand: <?= $item->quantity ?>.000 Unit(s)</div>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="panel-heading" style="border-top: 1px solid #eee;"></div>
	</div>
</div>
