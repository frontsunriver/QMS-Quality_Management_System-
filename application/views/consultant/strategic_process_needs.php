                    ...
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="process_needs_type" id="process_needs_type" onchange="get_process_list('needs')">
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <a data-toggle="modal" data-target="#needs_type" class="btn btn-primary">MANAGE</a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    <?php if ($user_type == "consultant"): ?>
                                        <a onclick="add('needs')" style="float: right" class="btn btn-primary">ADD</a>
                                    <?php endif;?>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table datatable-basic table-bordered datatable-swot">
                        ...
                        <?php foreach ($needs as $row): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="icons-list">
                                        <li><a href="#" onclick="edit(<?=$row->id?>,'needs')" type="button" title="Edit" class="btn btn-primary btn-sm" style="color: white;">Edit</a></li>
...
<!--                        <a type="button" class="btn btn-primary" style="margin: 10px;margin-bottom: 0px;width: 100px;" href = "../outsource_process/--><?//=$risk_id?><!--">Next</a>-->
                    </div>
                </div>
                <!-- /basic datatable -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Needs and expectation Info</h5>
            </div>
...
<script type="text/javascript">
    ...
    function get_process_list(flag){
        $('#get_flag').val(flag);
        if (flag == "needs"){
            $('#get_value_swot').val($('#process_needs_type').val());
        }else{
            $('#get_value_swot').val($('#process_needs_type').val());
        }
...
<?php $this->load->view('consultant/manage/needs_type'); ?>
</html>
