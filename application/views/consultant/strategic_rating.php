				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<button type="button" class="btn btn-primary" style="margin: 10px;margin-bottom: 0px;width: 100px;" onclick="show_edit()">Edit</button>
						</div>
	...
	function next_url(){
		$.ajax({
			...
			success : function(data) {
				...
				if (data.success == 1){
					location.href = "../strategic_process/<?=$id?>";
				}else{
					new PNotify({
						title: 'Message',
