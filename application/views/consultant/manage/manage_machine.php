...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('.datatable-customer tbody').on('click', 'a[title="Edit"]', function () {
            ...
            $('#info_form input[name="location"]').val(data.location);
            $('#info_form input[name="last_maintenance"]').val(data.last_maintenance);
            $('#info_form input[name="next_maintenance"]').val(data.next_maintenance);
