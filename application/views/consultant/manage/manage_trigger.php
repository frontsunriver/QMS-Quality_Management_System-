            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Trigger</h5>
                    </div>
                    <div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title">Trigger Info</h5>
                            </div>
                            <form id="info_form">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" placeholder="" name="trigger" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/trigger.js"></script>
</body>
</html>
