                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Number</label>
                                                <input type="text" placeholder="number" name="number" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                ...
                <div id="modal_content" class="modal fade">
                    <div class="modal-dialog" style="width: 900px;">
                        <div class="modal-content" style="width: 900px;">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/Consultant/record_save_content" method="post">
                ...
                <div id="modal_export" class="modal fade">
                    <div class="modal-dialog" style="width: 900px;">
                        <div class="modal-content" style="width: 900px;">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/Consultant/download_content_pdf_record" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/record.js"></script>
