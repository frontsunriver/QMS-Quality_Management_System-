                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label>Phone</label>
                                                <input type="text" placeholder="9-999-999-9999" name="phone" data-mask="9-999-999-9999" class="form-control">
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/supplier.js"></script>
</body>
</html>
