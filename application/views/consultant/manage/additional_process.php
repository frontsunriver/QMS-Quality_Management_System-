            ...
            <div class="content">
                ...
                <div class="panel panel-flat" id="ptn">
                    ...
                    <div>
                        ...
                        <?php endif;?>
                        <a href="<?php echo base_url(); ?>index.php/Consultant/download_content_pdf_additional_process" class="btn btn-primary pull-right" style="margin-right: 20px;float: left;">Export</a>
                    </div>
                ...
                <div id="modal_content" class="modal fade">
                    <div class="modal-dialog" style="width: 900px;">
                        <div class="modal-content" style="width: 900px;">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/Consultant/additional_process_save_content" method="post">
                ...
                <div id="modal_export" class="modal fade">
                    <div class="modal-dialog" style="width: 900px;">
                        <div class="modal-content" style="width: 900px;">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/Consultant/download_content_pdf_additional_process" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/additional_process.js"></script>
