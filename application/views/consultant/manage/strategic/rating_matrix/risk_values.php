            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Guide for impact levels</h5>
                    </div>
                    <div>
                    ...
                    <table class="table datatable-risk-values">
                    </table>
                </div>
                <!-- /basic datatable -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title">Risk Values Information</h5>
                            </div>
                            <form id="info_form">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Color</label>
                                                <input type="text" name="color" class="form-control colorpicker-show-input" data-preferred-format="hex">
                                            </div>
                                        </div>
                                    </div>
                                    <?php if ($type != 0):?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <select class="form-control" name="type">
                                                        ...
                                                        <option value="5">TACCP</option>
                                                        <option value="6">VACCP</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/risk_values.js"></script>
<style type="text/css">
  .sp-container { z-index:99999!important;}
</style>
<script>
    var type = "<?=$type?>";
</script>
