            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Evaluating risks and opportunities</h5>
                    </div>
                    <div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="opportunity" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/risks_opportunities.js"></script>
</body>
</html>
