            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Control Actions</h5>
                    </div>
                    <div>
                    ...
                    <table class="table datatable-control-actions">
                    </table>
                </div>
                <!-- /basic datatable -->
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/control_actions.js"></script>
</body>
</html>
