            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Assessment Controls</h5>
                    </div>
                    <div>
                    ...
                    <table class="table datatable-assessment-controls">
                    </table>
                </div>
                <!-- /basic datatable -->
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Rating</label>
                                                <input type="text" placeholder="" name="rating" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Action</label>
                                                <input type="text" placeholder="" name="action" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/assessment_controls.js"></script>
</body>
</html>
