...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <!-- Basic datatable -->
                <form class="form-horizontal" method="post" action="<?php echo  base_url(); ?>index.php/consultant/add_risk_scope">
                    <input type="hidden" name="id" value="<?=$id?>">
                    <input type="hidden" name="risk_id" value="<?=$risk_id?>">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Scope</h5>
                        </div>
                        <div class="row">
                            <div class="panel-heading col-md-6">
                                <textarea class="form-control" name="scope" rows="10"><?=$scope?></textarea>
                            </div>
                        </div>
                        <div class="panel-heading">
                            <a type="button" class="btn btn-primary" style="margin: 10px;margin-bottom: 0px;width: 100px;" onclick="window.history.back()">Back</a>
                            <button type="submit" class="btn btn-primary" style="margin: 10px;margin-bottom: 0px;width: 100px;">Next</button>
                        </div>
                    </div>
                </form>
                <!-- /basic datatable -->
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/outsource_process.js"></script>
<script>
    var risk_id = "<?=$risk_id?>";
