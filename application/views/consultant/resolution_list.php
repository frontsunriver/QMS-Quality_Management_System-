...
//            });
            ...
            $("<button type='button' class='btn btn-primary' id='chart_btn'>Chart</button>").insertAfter("#DataTables_Table_0_filter");

            $("#chart_btn").click(function(){
                location.href = '<?= base_url("consultant/analytics") ?>';
            });
        });
    </script>
</head>
						...
						<table class="table datatable-basic">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="<?php echo base_url(); ?>index.php/consultant/resolution/<?=$standalone->id?>" class="btn btn-primary">Load</a>
									</td> 
									<!-- <td>
									<ul class="icons-list">
