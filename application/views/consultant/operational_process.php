            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Outsource Processes</h5>
                    </div>
                    <div>
                        <?php if ($user_type == "consultant"): ?>
                            <button type="button" id="new_out_process" class="btn btn-primary pull-right" style="margin-right: 20px;">
                                ADD</button>
                        <?php endif;?>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title">Internal Processes</h5>
                    </div>
                    <div>
                        <?php if ($user_type == "consultant"): ?>
                            <button type="button" id="new_internal_process" class="btn btn-primary pull-right" style="margin-right: 20px;">
                                ADD</button>
                        <?php endif;?>
                    </div>

                    <table class="table datatable-internal">
                    </table>
                    <div class="panel-heading">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="form_process">
                                ...
                                <input type="hidden" class="form-control" name="risk_id" value="<?=$risk_id?>">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12" style="margin-top: 10px;">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="process_owner" id="process_owner">
...
<!-- /page container -->
<script type="text/javascript" src="<?=base_url();?>assets/js/user/operational_out_process.js"></script>
<script type="text/javascript" src="<?=base_url();?>assets/js/user/operational_internal_process.js"></script>
<script>
    var risk_id = "<?=$risk_id?>";
    var flag = "0";
