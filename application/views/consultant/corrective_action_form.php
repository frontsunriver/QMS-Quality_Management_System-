										...
										<div class="col-lg-12">
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-12">
													...
													<textarea class="form-control" name="prob_desc" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
											    	<span class="help-block">Process Owner:</span>
													    <select name="responsible_party" id="responsible_party" class="form-control" onchange="findresponsible(this.value);" required>
						                                     <?php foreach ($employees as $employee) { ?>
						                                       <option value="<?=$employee->employee_id?>"><?=$employee->employee_name?></option>
						                                     <?php } ?>
						                                </select>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
              ...
              var cur_role_id = $("#responsible_party").val();
              findresponsible(cur_role_id);
  });
