	...
	<div class="panel panel-flat">
		<div class="panel-heading" style="border-bottom: 1px solid #eee;">
			...
			<div class="pull-right">
				<a class="btn btn-default" href="<?= base_url('procurement/transfer') ?>">Back</a>
			</div>
		</div>
		<div class="container-fluid" style="padding-right: 6px;">
			<div class="row col-md-12" style="padding-right: 0px;">
				<div class="row col-md-12" style="margin-bottom: 10px;">
					<button type="button" class="btn btn-default" onclick="javascript:onDownloadPDF(<?= $transfer->id ?>);">Download PDF</button>&nbsp;&nbsp;
...
<script type="text/javascript" src="<?= base_url(JS_URL . 'user/procurement/transfer/view.js') ?>"></script>