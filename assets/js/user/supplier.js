$(function() {
    ...
    $('.datatable-supplier tbody').on('click', 'a[title="Edit"]', function () {
        ...
        $('#info_form input[name="material"]').val(data.material);
    ...
    $('.datatable-supplier tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post('supplier_delete', params, function(data, status){
    ...
    var validator1 = $("#info_form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post('supplier_save', params, function(data, status){
                if (data.success) {
                    new PNotify({
                        title: 'Success',
