$(function() {
    ...
    var table = $('.datatable-out').DataTable({
        ...
        "bAutoWidth": false,
        "sAjaxSource": base_url+'additional_process_read',
    ...
    $('.datatable-out tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post(base_url+'delete_manage_additional_process', params, function(data, status){
    ...
    var validator = $("#form_process").validate({
        ...
        submitHandler: function (form) {
            ...
            C.open("POST", 'add_additional_process');
            C.onload = function() {
                var E;
                E = C.responseText;
