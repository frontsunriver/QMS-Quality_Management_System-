$(function() {
    ...
    var table = $('.datatable-control-actions').DataTable({
        "bServerSide": true,
        "bProcessing": true,
        "aoColumns": [
                    {
        ...
        "bAutoWidth": false,
        "sAjaxSource": 'control_actions_read',
        "sAjaxDataProp": "control_actions",
        scrollX: false,
        scrollCollapse: true,
        "order": [
            [1, "asc"]
    ...
    $('.datatable-control-actions tbody').on('click', 'a[title="Edit"]', function () {
    ...
    $('.datatable-control-actions tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post('control_actions_delete', params, function(data, status){
    ...
    var validator1 = $("#info_form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post('control_actions_save', params, function(data, status){
                if (data.success) {
                    new PNotify({
                        title: 'Success',
