...
$(function(){
	var table = $('.datatable-customer').DataTable({
		...
		"aoColumns" : [{
			...
			"sTitle" : "Phone", "mData": "phone", "sWidth": "20%"
		}, {
			"sTitle" : "Street Address", "mData": "address", "sWidth": "20%"
		}, {
			"sTitle" : "Email Address", "mData": "email", "sWidth": "20%"
		}, {
	...
	$("#add_form").validate({
		...
		submitHandler: function (form) {
			...
			$.post(base_url + 'sales/customer/add', params, function(resp){
				if (resp.success) {
					new PNotify({
						title: 'Success',
...
function onAdd() {
	$("#modal_save .modal-body").load(base_url + 'sales/customer/add', {}, function(){
...
function onEdit(id) {
	$("#modal_save .modal-body").load(base_url + 'sales/customer/add', {id: id}, function(){
...
function onDelete(id) {
	 bootbox.confirm("Do you really delete this customer?", function(result){
	 	if (result) {
	 		$.post(base_url + 'sales/customer/delete/' + id, {}, function(resp, status){
	 			if (resp.success) {
					new PNotify({
						title: 'Success',
