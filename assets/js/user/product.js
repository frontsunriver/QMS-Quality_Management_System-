$(function() {
    ...
    var table = $('.datatable-customer').DataTable({
        ...
        "aoColumns": [
                    ...
                    { "sTitle" : "Code", "mData": "code", "sWidth": 100 },
                    { "sTitle" : "UPC Number", "mData": "upc_number", "sWidth": 100 },
                    { "sTitle" : "Barcode", "mData": "barcode_info", "sWidth": 100 },
                    { "sTitle" : "Size", "mData": "size", "sWidth": 100 },
                    { "sTitle" : "Packaging Type", "mData": "packaging_type", "sWidth": 100 },
    ...
    $('.datatable-customer tbody').on('click', 'a[title="Edit"]', function () {
        ...
        $('#info_form input[name="code"]').val(data.code);
        $('#info_form input[name="upc_number"]').val(data.upc_number);
    ...
    $('.datatable-customer tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post('delete_product', params, function(data, status){
                    if (status == "success") {
                        new PNotify({
                            title: 'Success',
    ...
    var validator1 = $("#info_form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post('edit_product', params, function(data, status){
                if (data != "") {
                    new PNotify({
                        title: 'Success',
