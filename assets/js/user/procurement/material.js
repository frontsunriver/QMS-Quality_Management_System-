...
$(function(){
	...
	$("#add_form").validate({
		...
		submitHandler: function (form) {
			...
			$.post(base_url + 'procurement/material/add', params, function(resp){
				if (resp.success) {
					new PNotify({
						title: 'Success',
...
function onAdd() {
	$("#modal_save .modal-body").load(base_url + 'procurement/material/add', {}, function(){
...
function onEdit(id) {
	$("#modal_save .modal-body").load(base_url + 'procurement/material/add', {id: id}, function(){
...
function onDelete(id) {
	bootbox.confirm("Do you really delete this material?", function(result){
		if (result) {
			$.post(base_url + 'procurement/material/delete/' + id, {}, function(resp, status){
				if (resp.success) {
					new PNotify({
						title: 'Success',
