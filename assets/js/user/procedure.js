$(function() {
    ...
    var table = $('.datatable-procedure').DataTable({
        "bServerSide": true,
        "bProcessing": true,
        "aoColumns": [
                    {
                    ...
                    { "sTitle" : "Procedures Title", "mData": "name", "sWidth": 130 },
    ...
    $('.datatable-procedure tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post('procedure_delete', params, function(data, status){
