$(function() {
    ...
    var table = $('.datatable-customer').DataTable({
        ...
        "aoColumns": [
                    ...
                    { "sTitle" : "Name", "mData": "trigger_name", "sWidth": 300 },
                    {
        ...
        "bAutoWidth": false,
        "sAjaxSource": 'trigger_read',
        "sAjaxDataProp": "trigger",
        scrollX: true,
        scrollCollapse: true,
        "order": [
            [1, "asc"]
    ...
    $('.datatable-customer tbody').on('click', 'a[title="Edit"]', function () {
        ...
        $('#info_form')[0].reset();
        $('#info_form input[name="id"]').val(data.trigger_id);
        $('#info_form input[name="trigger"]').val(data.trigger_name);
    ...
    $('.datatable-customer tbody').on('click', 'a[title="Delete"]', function () {
        ...
        bootbox.confirm("Are you sure?", function(result) {
            if (result) {
                ...
                $.post('delete_trigger', params, function(data, status){
                    if (status == "success") {
                        new PNotify({
                            title: 'Success',
    ...
    var validator1 = $("#info_form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post('edit_trigger', params, function(data, status){
                if (data != "") {
                    new PNotify({
                        title: 'Success',
