...
$(function(){
	var table = $('.datatable-supplier').DataTable({
		...
		"aoColumns" : [{
			...
			"sTitle" : "Name", "mData": "name", "sWidth": "21%"
		}, {
			"sTitle" : "Phone", "mData": "phone", "sWidth": "21%"
		}, {
			"sTitle" : "Email Address", "mData": "email", "sWidth": "21%"
		}, {
			"sTitle" : "Street Address", "mData": "address", "sWidth": "21%"
		}, {
	...
	$("#add_form").validate({
		...
		submitHandler: function (form) {
			...
			$.post(base_url + 'manufacture/supplier/add', params, function(resp){
				if (resp.success) {
					new PNotify({
						title: 'Success',
...
function onAdd() {
	$("#modal_save .modal-body").load(base_url + 'manufacture/supplier/add', {}, function(){
...
function onEdit(id) {
	$("#modal_save .modal-body").load(base_url + 'manufacture/supplier/add', {id: id}, function(){
...
function onDelete(id) {
	 bootbox.confirm("Do you really delete this supplier?", function(result){
	 	if (result) {
	 		$.post(base_url + 'manufacture/supplier/delete/' + id, {}, function(resp, status){
	 			if (resp.success) {
					new PNotify({
						title: 'Success',
